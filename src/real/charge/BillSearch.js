...
/*
    ...
    개발방법
     -store (BillSearchStore, BillMonthSearchStore, BillYearSearchStore, PayStore)
...
class BillSearch extends React.Component {
  ...
  componentDidMount() {
    this.props.uiStore.changeHeadTitle('청구 요금 조회');
        ...
        <div className="topArea" ref={this.topRef}>
          <div className="inner_box">
            <div className="title_area">
              <h1 className="title">청구 요금 조회</h1>
            </div>
          </div>
        </div>
        <div className="contentArea" ref={this.contentRef}>
          <div className="inner_box">청구 요금 조회</div>
        </div>
        <div
