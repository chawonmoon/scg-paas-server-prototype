...
/*
    ...
    Route Url : /company/contractNumberSearch

    this.prorps 정보
     -
    
    개발방법
     -store (ContractNumberSearchStore)

*/

@inject('uiStore', 'contractNumberSearchStore')
@observer
class ContractNumberSearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  componentDidMount() {
    this.props.uiStore.changeHeadTitle('사용계약번호 찾기');
        ...
        <div className="topArea" ref={this.topRef}>
          <div className="inner_box">
            <div className="title_area">
              <h1 className="title">사용계약번호 찾기</h1>
            </div>
          </div>
        </div>
        <div className="contentArea" ref={this.contentRef}>
          <div className="inner_box">사용계약번호 찾기</div>
        </div>
        <div
