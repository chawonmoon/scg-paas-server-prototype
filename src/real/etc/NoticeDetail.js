...
class NoticeDetail extends React.Component {
  ...
  componentDidMount() {
    this.props.uiStore.changeHeadTitle('공지사항 상세');
        ...
        <div className="topArea" ref={this.topRef}>
          <div className="inner_box">
            <div className="title_area">
              <h1 className="title">공지사항 상세</h1>
            </div>
          </div>
        </div>
        <div className="contentArea" ref={this.contentRef}>
          <div className="inner_box">공지사항 상세</div>
        </div>
        <div
